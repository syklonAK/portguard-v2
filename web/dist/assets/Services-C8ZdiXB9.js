import{c as t,i as y,k as b,u as v,j as a,S as g,C as f,d as j,e as N,m as k,h as d,B as l}from"./index-2gG3NNRp.js";import{u as w}from"./useMutation-Ck2yYcci.js";import{R as _}from"./refresh-cw-ieAgcBGY.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const D=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]],I=t("square",D),$=[{id:"start",label:"Start",icon:M,variant:"success"},{id:"reload",label:"Reload",icon:_,variant:"secondary"},{id:"restart",label:"Restart",icon:B,variant:"secondary"},{id:"stop",label:"Stop",icon:I,variant:"danger"},{id:"enable",label:"Enable",icon:P,variant:"ghost"},{id:"disable",label:"Disable",icon:C,variant:"ghost"}];function Q(){const x=y(),{push:r}=b(),n=v({queryKey:["services"],queryFn:()=>d.services(),refetchInterval:8e3}),i=w({mutationFn:({engine:s,action:e})=>d.serviceAction(s,e),onSuccess:s=>{r("success",s.output?s.output:"Done"),x.invalidateQueries({queryKey:["services"]})},onError:s=>r("error",s.message)}),p=(s,e)=>a.jsxs(a.Fragment,{children:[a.jsx(l,{color:s==="active"?"green":s==="failed"?"red":"slate",children:s||"unknown"}),a.jsx(l,{color:e==="enabled"?"blue":"slate",children:e||"—"})]});return a.jsxs("div",{className:"space-y-4",children:[a.jsxs("div",{children:[a.jsx("h1",{className:"text-lg font-bold",children:"Services"}),a.jsx("p",{className:"text-xs text-slate-500 dark:text-slate-400",children:"Start / stop / reload the proxy engines. Reload validates the generated config first — a broken config never reaches the service."})]}),n.isLoading?a.jsx("div",{className:"flex justify-center py-16",children:a.jsx(g,{})}):a.jsx("div",{className:"grid grid-cols-1 gap-4 lg:grid-cols-2",children:["nginx","haproxy"].map(s=>{var o;const e=(o=n.data)==null?void 0:o[s];return a.jsxs(f,{children:[a.jsx(j,{title:s==="nginx"?"Nginx":"HAProxy",desc:(e==null?void 0:e.description)||(e!=null&&e.binary_installed?"systemd unit":"binary not installed"),right:a.jsxs("div",{className:"flex items-center gap-2",children:[a.jsx(N,{status:(e==null?void 0:e.active)==="active"?"up":(e==null?void 0:e.active)==="failed"?"down":"unknown"}),p(e==null?void 0:e.active,e==null?void 0:e.enabled_state)]})}),a.jsxs("div",{className:"space-y-3 p-5",children:[!(e!=null&&e.binary_installed)&&a.jsxs("p",{className:"rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700 dark:bg-amber-900/20 dark:text-amber-300",children:["The ",s," binary was not found on this server — install it or fix the path in Settings."]}),a.jsx("div",{className:"flex flex-wrap gap-2",children:$.map(({id:c,label:h,icon:u,variant:m})=>a.jsxs(k,{size:"sm",variant:m,disabled:i.isPending||!(e!=null&&e.binary_installed),onClick:()=>i.mutate({engine:s,action:c}),children:[a.jsx(u,{className:"h-3.5 w-3.5"}),h]},c))}),a.jsxs("div",{className:"grid grid-cols-2 gap-x-4 gap-y-1 border-t border-slate-100 pt-3 text-2xs text-slate-500 dark:border-slate-800",children:[a.jsx("span",{children:"Unit"}),a.jsx("span",{className:"font-mono",children:(e==null?void 0:e.unit)||s}),a.jsx("span",{children:"Sub state"}),a.jsx("span",{children:(e==null?void 0:e.sub)||"—"}),a.jsx("span",{children:"Main PID"}),a.jsx("span",{className:"font-mono",children:(e==null?void 0:e.pid)||"—"})]}),(e==null?void 0:e.error)&&a.jsx("p",{className:"text-2xs text-red-500",children:e.error})]})]},s)})})]})}export{Q as default};
